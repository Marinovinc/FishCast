...
<div id="layerSheet">
  ...
  <div class="grpT">Batimetria</div>
  <div class="lgrid">
    <label class="chip"><input type="checkbox" id="lSdb">Profondit&agrave; SDB</label>
    <label class="chip"><input type="checkbox" id="lSdbComp">Composito</label>
    <label class="chip"><input type="checkbox" id="lIso">Linee batim.</label>
    <label class="chip"><input type="checkbox" id="lIsoFine">Fitte 0,5&nbsp;m</label>
    <label class="chip"><input type="checkbox" id="lCanal">Canaloni</label>
  </div>
  ...
  <div class="acts">
    <button class="act" id="btnHome">&#127968; Partenza</button>
    <button class="act" id="btnCalib">&#127919; Calibra</button>
    <button class="act" id="btnOffline">&#11015; Offline</button>
  </div>
