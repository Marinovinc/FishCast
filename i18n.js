...
(function(){
  ...
  var DICT = {
    it: {
      ...
      'gal.title':'Le mie catture', 'gal.btn':'📷 Catture', 'gal.point':'Punto', 'gal.depth':'prof.',
      'gal.empty':'Nessuna cattura ancora. Usa 🎣 Segna sulla mappa: la foto si aggiunge dal modulo.',
      'ph.add':'Aggiungi foto', 'ph.remove':'Togli la foto', 'ph.working':'Preparo la foto…',
      'ph.failed':'Foto non caricata, riprova', 'ph.loading':'carico la foto…', 'ph.missing':'foto non più disponibile',
      'bk.photos':'foto', 'bk.packing':'Preparo il file con le foto…',
    ...
    en: {
      ...
      'gal.title':'My catches', 'gal.btn':'📷 Catches', 'gal.point':'Mark', 'gal.depth':'depth',
      'gal.empty':'No catches yet. Use 🎣 Mark on the map: the photo is added in the form.',
      'ph.add':'Add photo', 'ph.remove':'Remove photo', 'ph.working':'Preparing the photo…',
      'ph.failed':'Photo not loaded, try again', 'ph.loading':'loading the photo…', 'ph.missing':'photo no longer available',
      'bk.photos':'photos', 'bk.packing':'Packing the file with the photos…',
