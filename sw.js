...
const CACHE = 'fishcast-v18';
const ASSETS = ['./', './index.html', './m.html', './engine.js', './wx.js', './solunar.js', './i18n.js', './access.html', './guida.html', './privacy.html', './manifest.webmanifest', './icon-192.png', './icon-512.png'];
